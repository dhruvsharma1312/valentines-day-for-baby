...
const Qualities = () => {
  ...
  const qualities = [
    { icon: "🌞", title: "Your Shiny Natural Curls", desc: "Makes my day shine" },
    { icon: "😂", title: "Your humour is the absolite best", desc: "You alwaysss make me laugh" },
    { icon: "🎵", title: "Your Sweet Voice", desc: "Makes me feel I am at home" },
    { icon: "🥺", title: "Your Lovely and Unique Smile", desc: "Iy just meltsss meeee" },
    { icon: "✨", title: "Your Honey brown eyes", desc: "When I look into them, I get lostttt" },
