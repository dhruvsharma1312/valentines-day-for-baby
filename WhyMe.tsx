...
const WhyMe = () => {
  ...
  const whyMeReasons = [
    { icon: "🫂", title: "I'm your strong baby", desc: "Will always protect you and keep you safe forever" },
    { icon: "🎵", title: "My voice is your favourite song ", desc: "I hope so" },
    { icon: "🤗", title: "I will handle all of your tantrums and mood swings", desc: "I promiseeee" },
