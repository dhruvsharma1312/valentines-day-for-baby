...
const Timeline = () => {
  ...
  const timelineEvents = [
    { icon: "🌟", title: "Starting From Here", desc: "10th Jan, 2024, single handedly changed my entire life" },
    { icon: "💌", title: "We talked", desc: "We started talking, coming on calls, video calls and made a strong bond" },
    { icon: "🎵", title: "Our first kiss, first hug", desc: "Your my first everything" },
